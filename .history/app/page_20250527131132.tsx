...
export default function Index() {
  ...
  // Form states
  const [aForm, setAForm] = useState<number | null>(null)
  const [bForm, setBForm] = useState<number | null>(null)
  const [cForm, setCForm] = useState<number | null>(null)
  const [dForm, setDForm] = useState<number | null>(null)
